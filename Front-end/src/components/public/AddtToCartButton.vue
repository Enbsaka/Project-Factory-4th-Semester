...
async function onAddToCart() {
  ...
  // Exigir seleção SOMENTE quando o produto tiver variações
  ...
  try {
    ...
    console.log('Payload enviado ao carrinho:', atualizados)
    ...
    console.log('Carrinho após atualizar:', carrinhoAtual)
    ...
    console.error('Erro ao adicionar ao carrinho:', msg)
    alert(String(msg))
  }
}
</script>